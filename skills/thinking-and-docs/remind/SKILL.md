...
MAKE SURE to always repeat the very first user prompt in this conversation, reminding David of the very first user message in this chat, so he is aware how the entire converastion started.
