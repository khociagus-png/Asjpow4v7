              ...
              <div class="upload-card">
                <div class="upload-top">
                  <div class="upload-left">
                    ...
                    <div><div class="upload-title">${t}</div><div class="upload-sub">Format: Gambar/PDF \u2022 Maks 2 MB</div></div>
                  </div>
                  <button type="button" onclick="document.getElementById('extra_${l}').click()" class="upload-btn" style="background:rgba(255,255,255,0.1); color:#fff; border:1px solid rgba(255,255,255,0.2);">UPLOAD</button>
                </div>
                <input id="extra_${l}" type="file" accept=".pdf" hidden onchange="handleExtraFile(this, ${l})">
