...
var A = localStorage.getItem('asj_lang') || 'id';
...
async function q() {
  ...
  y = (async () => {
    try {
      ...
      if (window.__ASJ_JP_LOCALE__) return ((L.jp = window.__ASJ_JP_LOCALE__), (ya = !0), !0);
    } catch (e) {
...
async function Z() {
  let a = A === 'id' ? 'jp' : 'id';
  (a === 'jp' && (await q()), (A = a), (window.CURRENT_LANG = A));
  try {
    localStorage.setItem('asj_lang', A);
  } catch {}
  (typeof K == 'function' && K(),
...
typeof requestIdleCallback == 'function'
  ? requestIdleCallback(() => {
      localStorage.getItem('asj_lang') === 'jp' && q();
    })
  : localStorage.getItem('asj_lang') === 'jp' && setTimeout(() => q(), 2e3);
var M = null,
  ue = {
...
async function ce(a, e) {
  try {
    let i = await E('registerFcmToken', [a, e, navigator.userAgent]);
  ...
  ea = (a) => {
    if (document.visibilityState === 'hidden') {
      ...
      isFinite(P) ||
        ...
        removeEventListener('prerenderingchange', ea, !0));
    }
  },
  D = (a = !1) => {
    if ((a && (P = 1 / 0), P < 0)) {
      ...
      ((P =
        ...
        addEventListener('visibilitychange', ea, !0),
        addEventListener('prerenderingchange', ea, !0),
        N(() => {
          setTimeout(() => {
            P = La();
          });
...
var ia = class {
          ...
          w(
            ...
            (l) => {
              l.forEach((d) => {
                ...
                let p = Math.max((d.presentationTime || d.paintTime || 0) - d.startTime, 0);
                ((s = k(
                  'FCP',
                  p,
                  'soft-navigation',
    ...
    _a(
      Oa(() => {
        let t,
          ...
          r = U(e, ia),
          s = (_, m, u, c, h) => {
            ((n = k('CLS', 0, _, m, u, c, h)), (r.i = 0), (t = g(a, n, Da, e.reportAllChanges)));
          },
          o = (_ = !1) => {
            (r.i > n.value && ((n.value = r.i), (n.entries = r.o)), t(_));
          },
          l = (_) => {
            (o(!0), s('soft-navigation', _.navigationId, _.interactionId, _.name, _.startTime));
          },
          d = (_) => {
            for (let m of _) m.entryType !== 'soft-navigation' ? r.h(m) : l(m);
            o();
          },
          p = ['layout-shift'];
        C(e) && p.push('soft-navigation');
        let b = w(p, d);
        b &&
          ((t = g(a, n, Da, e.reportAllChanges)),
          i.onHidden(() => {
            (d(b.takeRecords()), t(!0));
          }),
          N(() => {
  ...
  na,
  Ra = () => (na ? xa : (performance.interactionCount ?? 0)),
  fe = () => {
    'interactionCount' in performance || na || (na = w(['event'], ke, { durationThreshold: 0 }));
  },
  ra = class {
    u = 0;
    v = [];
  ...
  Wa = (a, e = {}) => {
    ...
    O(() => {
      ...
      let t,
        ...
        r = U(e, ra),
        s = (_, m, u, c, h) => {
          (r.M(), (n = k('INP', -1, _, m, u, c, h)), (t = g(a, n, Ca, e.reportAllChanges)));
        },
        o = () => {
          let _ = r.L(n.navigationType);
          _ && _.P !== n.value && ((n.value = _.P), (n.entries = _.entries), t());
        },
        l = (_) => {
          (o(), t(!0), s('soft-navigation', _.navigationId, _.interactionId, _.name, _.startTime));
        },
        d = (_, m = !1) => {
          Ga(() => {
            for (let u of _) u.entryType !== 'soft-navigation' ? r.h(u) : l(u);
            (o(), m && t(!0));
          });
        },
        p = ['event', 'first-input'];
      C(e) && p.push('soft-navigation');
      let b = w(p, d, { ...e, durationThreshold: e.durationThreshold ?? 40 });
      ((t = g(a, n, Ca, e.reportAllChanges)),
        b &&
          (i.onHidden(() => {
            d(b.takeRecords(), !0);
          }),
  ...
  Ha = (a, e = {}) => {
    ...
    O(() => {
      let n,
        ...
        l = (m, u, c, h, T) => {
          ((s = k('LCP', -1, m, u, c, h, T)),
            (n = g(a, s, X, e.reportAllChanges)),
            (i = !1),
            m === 'soft-navigation' && (r = D(!0)));
        },
        d = (m) => {
          (o.l && m.navigationId && Ua(o.l, m),
            i || n(!0),
            l('soft-navigation', m.navigationId, m.interactionId, m.name, m.startTime));
          let u = m.getLargestInteractionContentfulPaint?.();
          u && p([u]);
        },
        p = (m) => {
          e.reportAllChanges || t || (m = m.slice(-1));
          for (let u of m) {
            if (!u) continue;
            if (u.entryType === 'soft-navigation') {
              d(u);
              continue;
            }
            let c = 0,
              h = [],
              T = u.startTime;
            if (u.entryType === 'largest-contentful-paint')
              ((c = Math.max(u.startTime - R(), 0)), o.h(u), (h = [u]));
            else if (u.entryType === 'interaction-contentful-paint') {
              let I = u;
              if (
                !s.navigationId ||
              ...
              ((T = I.largestContentfulPaint?.renderTime || 0),
                (c = Math.max(T - u.startTime, 0)),
                I.largestContentfulPaint &&
                  (o.h(I.largestContentfulPaint), (h = [I.largestContentfulPaint])));
            }
            T < r.firstHiddenTime && ((s.value = c), (s.entries = h), n());
          }
        },
        b = ['largest-contentful-paint'];
      t && b.push('interaction-contentful-paint', 'soft-navigation');
      let _ = w(b, p);
      if (_) {
        n = g(a, s, X, e.reportAllChanges);
        let m = ['keydown', 'click', 'visibilitychange'],
          u = (c) => {
            if (c.isTrusted && !i) {
              let h = s.id;
              Ga(() => {
                if (!i) {
                  if (!t) {
                    _.disconnect();
                    for (let T of m) removeEventListener(T, u, { capture: !0 });
                  }
                  h === s.id && ((i = !0), n(!0));
                }
              });
        ...
        for (let c of m) addEventListener(c, u, { capture: !0 });
        N((c) => {
  ...
  oa = (a) => {
    document.prerendering
      ...
      : document.readyState !== 'complete'
        ? addEventListener('load', () => oa(a), !0)
        : setTimeout(a);
  },
  Va = (a, e = {}) => {
    let i = C(e),
      t = k('TTFB'),
      n = g(a, t, aa, e.reportAllChanges);
    oa(() => {
      let r = da();
      if (r) {
  ...
  if (!Za && Ya)
    try {
      ...
      (f.init({
        ...
        integrations: [f.browserTracingIntegration()],
        beforeSend(e) {
        ...
        window.addEventListener('error', (e) => {
          e.error && f && f.captureException(e.error);
        }),
        window.addEventListener('unhandledrejection', (e) => {
          e.reason && f && f.captureException(e.reason);
        }));
    } catch {}
}
var ie = {
    ...
    registerSeamAliases: ua,
    getSeamAliases: Te,
    dispatchSeamAction: te,
    checkInlineHandlers: x,
    flushGuardWarnings: ne,
  },
  j = new Map(),
  Qa = new Map();
function ua(a, e = {}) {
...
var Se = '[data-action]',
  Xa = !1;
function Pe(a) {
  return j.has(a) ? j.get(a) : typeof window[a] == 'function' ? window[a] : null;
}
function te(a, e, i) {
  let t = Pe(a);
...
function ae(a, e) {
  let i = a.target && a.target.closest ? a.target.closest(Se) : null;
  if (!i) return;
...
function x(a = document) {
  if (ve() && !(!a || typeof a.querySelectorAll != 'function'))
    for (let e of a.querySelectorAll('*'))
      for (let i of e.getAttributeNames()) {
        ...
        if (i === 'data-action') {
          ...
          for (; (o = ee.exec(s));) {
            let d = o[1],
              p = o[2],
              b = s[o.index - 1];
            if (!(!d && b === '.') && !Ie.has(p) && typeof window[p] != 'function') {
              l = p;
              break;
            }
          }
        ...
        let r = i + '|' + t + '|' + n;
        F.has(r) || F.set(r, { attr: i, name: t, label: n });
      }
}
function ne() {
  for (let { attr: a, name: e, label: i } of F.values())
...
ua(
  { callAPI: E, esc: G, escJs: W, resolveSelfUrl: H, requestNotificationPermission: Ka },
  { source: 'bridge:api-client' },
);
ua(
  { tr: S, trOption: Y, trOptionId: z, renderLanguageLight: K, toggleFormLanguage: Z, LANG: L },
  { source: 'bridge:i18n', allowNonFunction: !0 },
);
var ki = ie;
export {
  ie as PortalBridge,
  x as checkInlineHandlers,
  ki as default,
  te as dispatchSeamAction,
  ne as flushGuardWarnings,
  Te as getSeamAliases,
  we as initSeamDispatcher,
  ua as registerSeamAliases,
};
